...
namespace Controls
{
    public partial class Speech : UserControl
    {
        ...
        private void FindID(int index)
        {
            ...
            MessageBox.Show("ID not found.", "Goto", MessageBoxButtons.OK);
        }
        ...
        private void FindKeyWord(int index)
        {
            ...
            MessageBox.Show("KeyWord not found.", "Entry", MessageBoxButtons.OK);
        }
        ...
        private void OnClickSave(object sender, EventArgs e)
        {
            ...
            dataGridView1.Refresh();
            MessageBox.Show(String.Format("Speech saved to {0}", FileName), "Saved");
        }
