...
:INTRODUCTION()
ECHO THE 096 DISTRO WILL NOT BE FINISHED.
ECHO DISTRO DEVELOPMENT HAS BEEN MOVED TO CORE 097.
ECHO.
ECHO THIS IS BECAUSE I DON'T WANT TO WORK ON TWO DISTROS AT ONCE
ECHO ALSO, IT WOULD JUST BE MORE WORK FOR ME TO FINISH 096 NOW AND
ECHO THEN LATER, MOVE TO POL 097. IM DOING WHAT WORKS BEST FOR ME,
ECHO DON'T LIKE IT? *YOU* CAN ALWAYS FINISH 096! -AUSTIN
ECHO.
