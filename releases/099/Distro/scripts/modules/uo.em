...
//Fantasia Shard
const SHARD_NAME := "Fantasia Zulu";
const SHARD_VERSION := "7.0";
const SHARD_WEBSITE := "www.ForgottenZulu.tk";
const SHARD_LOGINSERVER := "LoginServer=fantasia.servegame.org,2593";
const SHARD_FORUM := "http://fantasiaserver.proboards.com/index.cgi";
const SHARD_MAINVOTE := "http://www.gamesites200.com/ultimaonline/in.php?id=1949";
const SHARD_IP := "fantasia.servegame.org";
const SHARD_WWWPORT := "2068";
